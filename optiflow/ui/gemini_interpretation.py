...
- **Сравнение алгоритмов:** скаляр F = w₁·P + w₂·O + w₃·R − Penalties при заданных весах. Penalties —
  штраф за нарушение когнитивного предела Миллера (Inv_3): растёт квадратично, если на каком-то экране
  больше 9 элементов; действует параллельно мультипликативной модели накопления нагрузки, а не вместо неё.
